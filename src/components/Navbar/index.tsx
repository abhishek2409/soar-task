...
const Navbar = ({ title }: { title: string }) => {
  return (
    <div className="ml-[250px] px-units-unit-40 py-units-unit-20">
      <div className="py-units-unit-13 flex justify-between pb-0">
        <h1 className="font-semibold text-units-unit-28 text-heading">
          {title}
        </h1>
        <div className="flex items-center justify-between gap-x-units-unit-30">
          <TextInput
            ...
            className={{
              ...
              input: 'rounded-full bg-primaryBG text-heading',
            }}
          />
          ...
          <Avatar className="w-[60px] h-[60px] rounded-full" img={AvatarIcon} />
        </div>
      </div>
    </div>
  );
