  ...
  return (
    ...
    >
      {avatarImage ? (
        <Avatar
          img={avatarImage}
          className="w-[50px] h-[50px] xl:w-[70px] xl:h-[70px] rounded-full flex-shrink-0"
        />
      ) : (
      ...
      <div className="flex flex-col gap-units-unit-5">
        <h3
          className={clsx(
            'text-menuActive text-units-unit-12 xl:text-units-unit-16',
        ...
        <p
          className={clsx(
            'text-contentSubtitle text-units-unit-12 xl:text-units-unit-15',
            selectedBeneficiary === id && 'font-semibold'
          )}
        >
          {alias}
