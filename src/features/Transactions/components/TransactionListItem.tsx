...
const TransactionIcon = ({
  ...
  return (
    <div
      className={clsx(
        'w-[50px] h-[50px] xl:w-[55px] xl:h-[55px] rounded-full flex-shrink-0 flex justify-center items-center',
        color,
        className
      )}
    >
    ...
    <div className="flex items-center gap-x-units-unit-13 justify-between">
      <div className="flex gap-x-units-unit-17">
        ...
        <div className="flex-col flex gap-y-units-unit-7">
          <h3 className="text-menuActive font-medium text-units-unit-14 xl:text-units-unit-16">
            {transactionDesctription}
          </h3>
          <p className="text-contentSubtitle text-units-unit-12 xl:text-units-unit-15">
            {transactionDate}
          </p>
        </div>
      </div>
      <div>
        <h3
          className={clsx(
            'font-medium xl:text-units-unit-16 text-units-unit-11',
